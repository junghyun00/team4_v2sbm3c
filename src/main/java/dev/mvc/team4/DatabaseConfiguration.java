...
@MapperScan(basePackages= {"dev.mvc.team4", "dev.mvc.park", "dev.mvc.admin", "dev.mvc.member",
                                              "dev.mvc.answer", "dev.mvc.pay", "dev.mvc.qna", "dev.mvc.reservation", 
                                              "dev.mvc.review","dev.mvc.survey", "dev.mvc.recommend"})
