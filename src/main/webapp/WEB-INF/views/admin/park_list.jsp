...
function delete_ajax(parkno) {
    var params= "";
    params = 'parkno=' + parkno;

    $.ajax({
        url: '/admin/park_delete_ajax.do',
        type: 'get',
        cache: false,
        async: true,
        dataType: 'json',
        ...
        success: function(rdata) {
            ...
            $('#modal_title').html('[ ' + name + ' ]' + ' 주차장 삭제 (관리자)');
	    ...
	    <!-- Modal content-->
	        <div class="modal-content">
	            ...
	            <div class="modal-footer">
	               <FORM name='frm_delete' id='frm_delete' method='POST' action='./park_delete.do'>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                   <c:forEach var="parkVO" items="${list }">
                        ...
                        <tr>
                            <td class="th_bs">
                                <a href="../park/read.do?memberno=${memberno }&parkno=${parkno}&now_page=${param.now_page }&address=${param.address}">${name }</a>
                            </td>    
                            ...
                            <td class="th_bs">
                                ...
                                <A href="javascript:delete_ajax(${parkno })" title="삭제"><i class="fas fa-trash-alt" ></i></A>
                            </td>
                        </tr>
